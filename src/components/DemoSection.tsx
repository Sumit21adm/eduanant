...
import { LayoutDashboard, Users, CalendarCheck, CreditCard, Settings, Moon, Lock } from 'lucide-react';
...
const screens = [
    {
        ...
        darkSrc: '/screenshots/dashboard-dark.webp',
    ...
    },
    {
        ...
        src: '/screenshots/students.webp',
        darkSrc: '/screenshots/students.webp', // Assuming single version for now
    ...
    },
    {
        ...
        darkSrc: '/screenshots/attendance.webp',
    ...
    },
    {
        ...
        src: '/screenshots/fees.webp',
        darkSrc: '/screenshots/fees.webp',
    ...
    },
    {
        ...
        darkSrc: '/screenshots/settings.webp',
            ...
            <div className="container mx-auto px-6 max-w-6xl text-center relative z-10">
                ...
                >
                    <h2 className="text-5xl md:text-6xl font-black text-text-primary mb-6 tracking-tight leading-tight">
                        ...
                        <span className="bg-gradient-to-r from-[#B45309] via-[#EA580C] to-[#F59E0B] dark:from-[#FBBF24] dark:via-[#F59E0B] dark:to-[#FB923C] bg-clip-text text-transparent">in Action</span>
                    </h2>
                    ...
                    {screens.map((s, i) => (
                        <button
                            ...
                            className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-300 border ${active === i
                                ...
                                : 'bg-paper text-text-secondary border-gray-200 dark:border-white/10 hover:border-primary-main/50 hover:text-primary-main dark:hover:text-[#00b6d5] dark:hover:bg-white/5'
                                }`}
                        >
                            {s.icon}
                            {s.label}
                                ...
                                <div className="bg-gray-50 dark:bg-gray-900/50 flex items-center gap-1.5 px-4 py-3 border-b border-gray-200/80 dark:border-white/10">
                                    ...
                                    <div className="flex-1 ml-4 flex justify-center sm:justify-start">
                                        <div className="bg-white dark:bg-black/40 rounded-md px-3 py-1.5 text-xs text-text-secondary text-left font-mono border border-gray-200 dark:border-white/10 w-full sm:max-w-xs flex items-center gap-2">
                                            <Lock className="w-3 h-3 opacity-50 inline-block" strokeWidth={1.5} /> www.eduananth.com
                                        </div>
                                    </div>
