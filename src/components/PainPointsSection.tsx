...
const PAIN_POINTS = [
    ...
    },
    {
        ...
        afterDetail: '16 modules that are tightly integrated. Fee dues auto-link with attendance reports.',
            ...
            <div className="container mx-auto px-6 max-w-7xl">
                    ...
                    return (
                        <motion.div
                            ...
                            <div className="relative rounded-3xl p-8 border border-red-500/20 bg-red-500/5 backdrop-blur-sm overflow-hidden group">
                                ...
                                <h3 className="font-display text-xl font-extrabold tracking-tight text-[#1E1B4B] dark:text-white mb-3">{pain.before}</h3>
                            ...
                            <div className={`relative rounded-3xl p-8 border ${colors.card} backdrop-blur-sm overflow-hidden group`}>
                                ...
                                <h3 className="font-display text-xl font-extrabold tracking-tight text-[#1E1B4B] dark:text-white mb-3">{pain.after}</h3>
                ...
                <motion.div
                    ...
                    <div className="inline-flex items-center gap-3 px-6 py-4 rounded-2xl bg-gradient-to-r from-primary-main/10 to-secondary-main/10 border border-primary-main/20">
                        <ChevronRight className="w-5 h-5 text-primary-main dark:text-amber-400" />
                        <p className="text-base font-bold text-text-primary">
                            EduAnant replaces <span className="font-semibold text-[var(--accent-text)]">registers, Excel sheets, Tally entries, and 3–5 other tools</span> — with one platform your whole school uses.
                        </p>
                    </div>
                </motion.div>
            </div>
