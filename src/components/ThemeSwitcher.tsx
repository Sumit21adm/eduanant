...
export default function ThemeSwitcher() {
    ...
    return (
        <div className="relative group inline-block">
            <button className="flex items-center gap-2 px-3 py-2 rounded-mui-btn text-text-secondary hover:text-primary-main dark:hover:text-[#00b6d5] hover:bg-primary-main/5 transition-colors">
                <Palette className="w-5 h-5 text-primary-main dark:text-[#00b6d5]" />
            ...
            <div className="absolute right-0 mt-1 w-48 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform origin-top-right scale-95 group-hover:scale-100 z-50">
                <div className="bg-paper rounded-mui-btn shadow-elevation-8 border border-gray-100 dark:border-white/10/10 py-2 ring-1 ring-black/5">
                    <div className="px-4 py-2 text-xs font-semibold text-text-secondary uppercase tracking-wider border-b border-gray-100 dark:border-white/10">
                        Select Color
                    </div>
                  ...
                  ${theme === t.id
                                        ? 'bg-primary-main/10 dark:bg-white/10 text-primary-main dark:text-[#00b6d5] font-medium'
