                        ...
                        <div className="bg-white/80 dark:bg-white/[0.02] border border-gray-200/50 dark:border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl backdrop-blur-sm">
                            ...
                            <div className="space-y-10 text-text-secondary leading-relaxed text-base md:text-lg">
                                ...
                                <section className="bg-blue-50 dark:bg-blue-900/10 p-6 rounded-2xl border border-blue-200/50 dark:border-blue-500/20">
                                    ...
                                    <p className="mb-4">The EduAnant mobile application (package name: <strong className="text-text-primary break-words">cloud.eduanant.app</strong>) provides access to the school portals and supports native features like push notifications. The app itself does <strong className="text-text-primary break-words">not store any personal data</strong> on our servers beyond what is required to maintain your login session and deliver notifications. Location is the single exception, and it is not stored either: at schools that have enabled campus geofencing, a staff member's coordinates are sent when they tap Check In, used once to confirm they are on campus, and then discarded — the server records only whether that check passed.</p>
