                        ...
                        <div className="space-y-10 text-text-secondary leading-relaxed text-base md:text-lg">
                            ...
                            <section className="bg-blue-50 dark:bg-blue-900/10 p-6 rounded-2xl border border-blue-200/50 dark:border-blue-500/20">
                                <h3 className="text-xl md:text-2xl font-bold text-text-primary mb-4 flex items-center gap-3">
                                    ...
                                    Android App — Additional Terms
                                </h3>
                                <p className="mb-4">The EduAnant SMS Android application (package name: <code className="text-xs bg-white/50 dark:bg-white/10 px-1.5 py-0.5 rounded border border-blue-200 dark:border-blue-500/30">cloud.eduanant.app</code>) is a Trusted Web Activity (TWA) that provides native access to the EduAnant web service. By downloading or using the Android app, you agree to these Terms in full, as well as the <a href="https://play.google.com/intl/en_us/about/play-terms/" target="_blank" rel="noopener noreferrer" className="text-[#00b6d5] hover:underline font-semibold">Google Play Terms of Service</a>.</p>
                                <ul className="space-y-2 list-none">
                                    {[
                                        ['App updates', 'We may release updates to the Android app at any time. Continued use of the app after an update constitutes acceptance of any revised terms. We recommend enabling auto-updates.'],
                                        ['Availability', 'We do not guarantee the app will remain available on Google Play indefinitely. We reserve the right to withdraw or unpublish the app with reasonable notice.'],
                                        ...
                                        ['App permissions', 'The app requests only the INTERNET permission to load the EduAnant web service. No device sensors, contacts, camera, microphone, or storage are accessed.'],
                                    ].map(([title, desc]) => (
